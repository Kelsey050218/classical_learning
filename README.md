...
本项目是一个面向中学生的经典文化学习平台，以朱自清先生《经典常谈》为核心文本，通过数字化手段帮助学生深入理解中国古代经典。平台采用"阅读—批注—闯关—创作—展览—修复"的完整学习闭环设计，支持智能 AI 辅助、在线协作和作品展示。
...
### 修复室（断简残编·经典复原室）
- **典籍修复** — 以"经典修复师"身份修复 13 部中华经典残卷
- **四步修复流程** — 研读诊断 → 碎片归筐 → 脉络排序 → 档案生成
- **档案馆升级** — 全部修复完毕后工作台升级为"经典溯源档案馆"，可探索典籍关联网络
...
### 文化素养雷达
- **8 维阅读素养评估** — 基于《中国青少年阅读素养框架》，混合自评与行为数据生成可视化雷达图
...
| 个人中心 | `/profile` | `/api/profile` |
| AI 学习助手 | 悬浮窗组件 | `/api/ai-chat` |
| 修复室 | `/restoration`, `/restoration/:chapterId`, `/restoration/archive` | `/api/restoration` |
